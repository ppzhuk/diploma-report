...
It also could be applied for the other IT-discussions sources such as forums, question-answers systems an so on. Practical results shows that this technique can be used to facilitate the creation of the FAQs.
}
